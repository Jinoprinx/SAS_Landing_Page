...
const FaqItem = ({ item , index}) =>{
    ...
    return(
        <div className="relative z-2 mb-16">
            ...
            <div className={clsx('g5 -bottom-7 -top-7 left-0 right-0 -z-1 rounded-3xl opacity-0 transition-opacity absolute', active && 'opacity-100')}>
                <div className="g7 absolute inset-0.5 -z-1 rounded-3xl"/>
